// CreateLayer.cpp : Defines the initialization routines for the DLL.
//
...
void createLayer()
{
	...
	if (pLayerTable->has(_T("OBJ")) == false)
	{
		...
		pLayerTableRecord->setName(_T("Aayush Layer"));
...
extern "C" AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt)
{
	...
	case AcRx::kInitAppMsg:
		...
		acedRegCmds->addCommand(_T("XYZ"), _T("userInfo"),
			_T("makeLayer"), ACRX_CMD_MODAL, createLayer);//addLine  makeLayer
		break;
